...
// Domain Statuses
export const DOMAIN_STATUSES = ["active", "expired", "pending-renewal"] as const;

// Import Classifications
export const IMPORT_CLASSIFICATIONS = ["subscription", "domain", "junk"] as const;
...
export const MAX_RECEIPT_SIZE_BYTES = MEGABYTES_FOR_MAX_RECEIPT * BYTES_PER_MEGABYTE; // 10MB
